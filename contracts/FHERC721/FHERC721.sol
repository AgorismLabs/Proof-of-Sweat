...
import {IERC721} from "@openzeppelin/contracts/token/ERC721/IERC721.sol"; // Import IERC721 interface
...
contract FHERC721 is IFHERC721, Permissioned, ERC721 {
  ...
  function mint(
    address to,
    uint256 tokenId,
    inEuint256 calldata privateData
  ) public {
    _mint(to, tokenId, privateData);
  }
  ...
  function transferOut(address _from, address _to, uint256 _tokenId) external {
    // Ensure that the sender is allowed to transfer the token
